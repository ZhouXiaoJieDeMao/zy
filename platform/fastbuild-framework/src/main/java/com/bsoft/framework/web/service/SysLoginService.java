...
import com.bsoft.common.core.redis.RedisCache;
import com.bsoft.common.exception.ServiceException;
import com.bsoft.common.exception.user.CaptchaException;
import com.bsoft.common.exception.user.CaptchaExpireException;
import com.bsoft.common.exception.user.UserPasswordNotMatchException;
import com.bsoft.common.utils.DateUtils;
import com.bsoft.common.utils.MessageUtils;
import com.bsoft.common.utils.StringUtils;
import com.bsoft.common.utils.ServletUtils;
import com.bsoft.common.utils.ip.IpUtils;
import com.bsoft.framework.manager.AsyncManager;
import com.bsoft.framework.manager.factory.AsyncFactory;
import com.bsoft.system.service.ISysConfigService;
...
//            // 该方法会去调用
////            UserDetailsServiceImpl.loadUserByUsernameauthentication = authenticationManager.authenticate(authenticationToken);
//        }catch (Exception e){
//            if (e instanceof BadCredentialsException){
//                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.LOGIN_FAIL, MessageUtils.message("user.password.not.match")));
//                throw new UserPasswordNotMatchException();
...
//            authentication = authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(username, password));
            authentication = authenticationManager.authenticate(new PreAuthenticatedAuthenticationToken(username,user.getPassword()));
        }catch (Exception e){
            if (e instanceof BadCredentialsException){
                AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.LOGIN_FAIL, MessageUtils.message("user.password.not.match")));
                throw new UserPasswordNotMatchException();
